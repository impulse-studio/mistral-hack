...
function drawChair(ctx: CanvasRenderingContext2D, col: number, row: number, color: string) {
...
function drawLamp(ctx: CanvasRenderingContext2D, col: number, row: number) {
...
function drawScene(ctx: CanvasRenderingContext2D) {
	...
	for (const d of DESKS) {
		drawDesk(ctx, d);
		const chairColor = d.screenColor === P.monitorScreen ? P.chair : P.chairAlt;
