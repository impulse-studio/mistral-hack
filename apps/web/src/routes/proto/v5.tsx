...
function RouteComponent() {
	...
	const [characters] = useState<Character[]>(() => structuredClone(CHARACTERS));
			...
			>
				...
				{selectedChar && (
					...
					>
						...
						<span
							...
							style={{
								background:
									selectedChar.status === "working"
										? "#00ff4120"
										: selectedChar.status === "talking"
											? "#ffcb0020"
											: "#ffffff10",
								color:
									selectedChar.status === "working"
				...
				<div className="flex-1 overflow-hidden">
					...
					{activeTab === "terminal" && (
						...
						>
							<div
								className="flex items-center gap-1.5 pb-1.5 mb-1.5 text-[10px]"
								style={{ borderBottom: "1px solid #00ff4130", color: "#00ff4180" }}
							>
								<span>●</span>
					...
					{activeTab === "tasks" && (
						<div className="h-full overflow-y-auto p-2">
							<div
								className="grid grid-cols-3 gap-1.5 h-full"
					...
					{activeTab === "files" && (
						...
						>
							<div
								className="flex items-center gap-1.5 pb-1.5 mb-1.5 text-[10px]"
								style={{ borderBottom: "1px solid #ffffff10", color: "#888" }}
							>
								<span>workspace</span>
