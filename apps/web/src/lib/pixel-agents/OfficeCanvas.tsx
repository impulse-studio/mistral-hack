...
import type { EditorRenderState, SelectionRenderState, DeleteButtonBounds, RotateButtonBounds } from './renderer'
...
import { getCatalogEntry, isRotatable } from './furnitureCatalog'
